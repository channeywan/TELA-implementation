...
class TIDAL(BaseAlgorithm):
    ...
    def __init__(self, ml_model: str, distill_model: str = "distilbert-base-multilingual-cased"):
    ...
    def predict_business_type(self, items: pd.DataFrame):
        ...
        for i in range(0, len(items), batch_size):
            batch_items = items.iloc[i:i+batch_size]
            description = batch_items['description']
