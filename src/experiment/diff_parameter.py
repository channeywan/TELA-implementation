...
if __name__ == "__main__":
    ...
    # bandwidth_utilization_list = []
    # capacity_utilization_list = []
    ...
    # tidal_analyzer.train_items = train_items
    # tidal_analyzer.test_items = test_items
    # tidal_analyzer.min_bandwidth_warehouse_num = 1
    # tidal_analyzer.run()
    # for algorithm_name in ["RoundRobin"]:
    #     analyzer = getattr(sys.modules[__name__], algorithm_name)()
    #     analyzer.test_items = test_items
    #     analyzer.run()
    otf=[]
    ...
    # tela_analyzer.violation_window_size = 1600
    # tela_analyzer.max_violation_occurrence = 650
    # tela_analyzer.run()
    # logger.info(f"tela_overload_duration: {tela_analyzer.overload_duration}")
    # logger.info(f"tela_overload_percentage: {tela_analyzer.overload_percentage}")
    # logger.info(f"tela_time_imbalance: {tela_analyzer.time_imbalance}")
    # logger.info(f"tela_space_imbalance: {tela_analyzer.space_imbalance}")

    # for target in ["min_delta_util_var", "min_util_var", "min_load_var", "min_delta_load_var", "min_peak_load_before_placement","min_peak_load_after_placement"]:
    #     analyzer = TIDAL()
